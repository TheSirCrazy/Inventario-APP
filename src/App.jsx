...
export default function App() {
  ...
  const [globalStoreSearch, setGlobalStoreSearch] =
    useState("");
  ...
  const filteredStores =
    ...
    // PESQUISA GLOBAL ENTRE TODAS AS LEVAS
    const allStores =
  ...
  const filteredGlobalStores =
    allStores.filter((store) =>
      store.name
        .toLowerCase()
        .includes(
          globalStoreSearch.toLowerCase()
        )
    );
...
{activeTab === "details" && (
  <div style={{ padding: "20px" }}>
    {!currentCampaign ? (
      <div>
        <h2>Nenhuma leva selecionada</h2>

        <p>
          Vá até a aba Inventários e abra
          uma leva.
        </p>
        ...
        <input
          type="text"
          placeholder="Pesquisar loja em TODOS os inventários..."
        ...
        {globalStoreSearch && (
          <div>
            ...
            {filteredGlobalStores.length ===
            0 ? (
              <p>
                Nenhuma loja encontrada.
              </p>
            ) : (
              filteredGlobalStores.map(
                (store) => (
                  <div
                    key={store.id}
                    style={{
      ...
      <>
        ...
        <input
          type="text"
          placeholder="Pesquisar loja nesta leva..."
          value={search}
          onChange={(e) =>
